    ...
    <div className="min-h-screen flex flex-col justify-center items-center p-4 sm:p-6 gradient-bg">
      <div className="w-full max-w-md mx-auto space-y-8 fade-in">
        ...
        <div className="text-center space-y-4">
          <div className="flex items-center justify-center mb-4">
            <div className="w-16 h-16 bg-primary/20 rounded-2xl flex items-center justify-center">
              <span className="text-2xl font-bold logo-text">SG</span>
            </div>
          </div>
        ...
        <Card className="p-6 glass-effect">
          <h2 className="text-xl font-semibold mb-4 text-center">{t('chooseLanguage')}</h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Button onClick={() => setShowUserType(true)} variant="outline" size="lg" className="h-14">
            {t('register')}
          </Button>
        </div>
